        ...
        Steps=[
            {
                ...
                'HadoopJarStep': {
                    ...
                    'Args': ['spark-submit', '--deploy-mode', 'cluster', '--master', 'yarn', script_path]
                }
            }
        ],
...
if __name__ == "__main__":
    try:
        # Step 1: Run EMR job for previously zipped scripts (now as raw main.py)
        run_emr_job(
            script_path="s3://glue-hospital-data/scripts/emr_scripts/main.py",
